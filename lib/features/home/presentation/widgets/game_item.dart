...
class GameStat {
  ...
  final String value;
  final String label;
  const GameStat({required this.icon, required this.value, required this.label});
}
...
class GameItem {
  ...
  final Color gradFrom;      // dark gradient start
  final Color gradTo;        // dark gradient end
  final String rating;       // e.g. "1420"
  final String rankLabel;    // e.g. "Diamond III"
  final List<GameStat> stats;
  final String playerCount;  // e.g. "32.4K"
...
const List<GameItem> games = [
  GameItem(
    title:       'Physics Duel',
    description: 'Test ballistics, optics & thermodynamics',
    emoji:       '🔭',
    category:    'SCIENCE',
  ...
  GameItem(
    ...
    description: 'Face off in rapid-fire judgment rounds. Test your gut instinct.',
    emoji:       '⚔️',
    category:    'MENTAL',
    accentColor: Color(0xFFEF4444),
    accentLight: Color(0xFFFCA5A5),
    gradFrom:    Color(0xFF3d1010),
    gradTo:      Color(0xFF200808),
    rating:      '1420',
  ...
  GameItem(
    ...
    description: 'Mathematics battles are under development',
    emoji:       '📐',
    category:    'LOGIC',
